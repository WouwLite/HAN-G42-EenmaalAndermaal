<?php include_once($_SERVER['DOCUMENT_ROOT'] . '/config/app.php'); ?>
                            ...
                            <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" class="force-full-width" style="margin:0 auto;">
                                <tr>
                                    <td style="font-size: 30px; text-align:center;">
                                        <br>
                                        <img src="http://iproject42.icasites.nl/storage/images/logo/logo-ea-groot-donker.png" alt="EenmaalAndermaalLogo"/>
                                        <br>
                                        <br>
                                    </td>
                                </tr>
                                            ...
                                            <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="60%">
                                                <tr>
                                                    <td style="color:#187272;">
                                                        <br>
                                                        U ontvangt hierbij uw activatiecode!
                                                        <br>
                                                        <br>
                                                    </td>
                                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <div><!--[if mso]>
                                            ...
                                            <![endif]-->
                                            <a href="http://"
                                               style="background-color:#178f8f;border-radius:4px;color:#ffffff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;"><?=$secretCode?></a>
                                            <!--[if mso]>
                                            </center>
                                            </v:roundrect>
                                            <![endif]--></div>
