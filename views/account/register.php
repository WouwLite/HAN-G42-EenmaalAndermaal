...
<div class="bg-overlay">
    <div class="container col-md-8 col-xs-6 jumbotron" style="background: rgba(236, 240, 241, 0.9);">
        <a href="<?= $app_url ?>" class="btn btn-default" role="button" aria-pressed="true"><i
                    class="fa fa-angle-double-left" aria-hidden="true"></i> Terug</a>
        <form class="form-horizontal sign-up-form" method="post" action="#">
            <div class="title">
                <img src="<?= $cdn_url ?>/storage/images/logo/logo-ea-groot-donker.png" style="max-height: 70px"
                     alt="EenmaalAndermaal Logo">
            </div>

            <!-- Melding voor registreren -->
            <div class="alert alert-info" role="alert">
                Heb je al een account? klik dan <a href="<?= $app_url ?>/views/account/login.php"><strong>hier</strong></a>
                om in te loggen.
            </div>
            ...
            <div <?php print((!empty($errors['email'])) ? 'class="form-group row has-danger"' : 'class="form-group row"'); ?>>
                <div class="input-group inputform">
                    <label
                    <span class="input-group-addon width50 fa fa-envelope" id="basicaddon1"></span></label>
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <small class="form-text text-muted">U dient eerst uw emailadres te verifiëren alvorens u verder kan
                        gaan met het registratieproces. Vul hieronder de ontvangen geheime code in:
                    </small>
                    <!-- Foutmelding -->
                    <div class="form-control-feedback"><?php global $errors;
                        echo $errors['email'] ?>
                ...
                <div class="col-md-4">
                    <div <?php print((!empty($errors['secretcode'])) ? 'class="form-group row has-danger"' : 'class="form-group row"'); ?>>
                        <div class="input-group inputform">
                            ...
                            <input type="text" id="secretcode" class="form-control" name="secretcode"
