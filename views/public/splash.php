...
<head>
    ...
    <link href="<?= $app_url ?>/assets/css/shop-homepage.css" rel="stylesheet">
    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="masthead clearfix">
                <div class="inner">
                    <p class="masthead-brand"><img src="<?= $cdn_url ?>/storage/images/logo/logo-ea-groot-licht.png"
                                                   style="max-height: 70px" alt="EenmaalAndermaal Logo"></p>
...
<!--                    </form>-->
            ...
            <div class="mastfoot">
                <div class="inner">
                    <p><a href="index.php"><i class="fa fa-gavel" aria-hidden="true"> Overzicht populaire biedingen</a>
                    </p>
                </div>
            </div>
